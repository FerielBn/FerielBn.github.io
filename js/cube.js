...
function generateCube(W, L, H, grdTexture, wallTexture) {
  ...
  function createScene() {
    ...
    var buildFromPlan = function (ground, walls, ply, H, options, scene) {
      ...
      // var x = positions[3 * p];
      // var y = positions[3 * p + 1];
      // var z = positions[3 * p + 2];
      // uvs.push((x + W / 2) / W, (z + L / 2) / L);
    ...
    var baseData = [-W / 2, -L / 2, W / 2, -L / 2, W / 2, L / 2, -W / 2, L / 2];
