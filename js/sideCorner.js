...
function generateSideCorner(H, W1, W2, W3, W4, grdTexture, wallTexture) {
  var W = W1;
  var L = W4;
  ...
  function createScene() {
    ...
    var buildFromPlan = function (ground, walls, ply, H, options, scene) {
      ...
      // (x, z) = (15, 10)
      for (var p = 0; p < positions.length / 15; p++) {
        uvs.push(
      ...
      /*
        uvs.push(
			0, 0.625, 0, -0.625, 0, -0.625, 0, 0.625,
			0, -0.625, 1.25, 0.625, 1.25, -0.625, 1.25, -0.625, 
			1.25, 0.625, 1.25, -0.625, 1.25, 0.625, 1.25, -0.625, 
			1.25, -0.625, 1.25, 0.625, 1.25, -0.625, 1, 0.625, 
			1, -0.625, 1, -0.625, 1, 0.625, 1, -0.625
		);
*/
    ...
    var shape = [
      ...
      new BABYLON.Vector3(W / 2 - (W1 - W3), 0, L / 2),
      new BABYLON.Vector3(-W / 2, 0, L / 2),
    ];
